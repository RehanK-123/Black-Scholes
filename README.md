This project is a simple options price prediction model, that uses the Black Scholes mathematical model to predict the price of an option, the model is based on the concept of brownian motion
